  ...
  return (
    <>
      ...
      <section className="relative min-h-screen overflow-hidden bg-cream">
        ...
        {/* ── Oversized Hero Text (Background, right side) — texture-level ── */}
        <div className="absolute top-1/2 -translate-y-1/2 right-0 z-[4] pointer-events-none select-none hidden md:block">
           <p className="text-[9vw] leading-[0.85] font-[EloquiaDisplay] text-foreground/[0.04] tracking-tight text-right pr-8" aria-hidden="true">
            ...
            <div className="relative w-full md:w-[62%] lg:w-[56%] xl:w-[52%] overflow-visible">
              ...
              >
                ...
                <div className="relative px-7 sm:px-9 md:px-10 lg:px-12 pt-10 sm:pt-12 md:pt-14 pb-6 sm:pb-8">
                  ...
                  {/* Serie / Edition — editorial serif micro-label */}
                  <p className="reveal delay-200 text-[0.6rem] tracking-[0.22em] uppercase text-warm-gray font-[EloquiaText] italic mb-5">
                  ...
                  <p className="reveal delay-300 mt-4 text-sm sm:text-[0.95rem] text-slate font-[SatoshiMedium] leading-relaxed max-w-sm">
                    Caffè di selezione, vinili, e le persone giuste.<br className="hidden sm:block" />
                ...
                <div className="relative px-7 sm:px-9 md:px-10 lg:px-12 pt-6 sm:pt-7 pb-8 sm:pb-10 md:pb-12">

                  {/* Date + Venue + CTA — single aligned row */}
                  <div className="reveal delay-500 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
                    ...
                    <div className="flex items-baseline gap-3">
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <span className="text-[0.58rem] tracking-[0.18em] uppercase text-slate font-[SatoshiMedium] mt-0.5">DOMENICA</span>
                      </div>
                    </div>

                    {/* Center: Venue — editorial serif treatment */}
                    <div className="flex flex-col items-start sm:items-center">
                      <p className="text-[0.55rem] tracking-[0.22em] uppercase text-warm-gray font-[EloquiaText] italic">
                        ospitato da
                      </p>
                      <p className="text-xl sm:text-2xl font-[EloquiaDisplay] font-bold text-foreground leading-tight">
                        Martinucci
                      </p>
                      <p className="text-[0.65rem] tracking-[0.14em] font-[EloquiaText] italic text-slate mt-0.5">
                        Lecce, Puglia
                      </p>
                    </div>
                  ...
                  <p className="reveal delay-600 mt-5 text-[0.55rem] tracking-[0.18em] uppercase text-warm-gray font-[EloquiaText] italic text-center">
